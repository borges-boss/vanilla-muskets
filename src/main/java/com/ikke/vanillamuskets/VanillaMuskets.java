...
public class VanillaMuskets
{
    ...
    //Wooden Musket item
    public static final RegistryObject<Item> MUSKET_ITEM = ITEMS.register("musket",() -> new Musket(new Item.Properties().stacksTo(1).durability(3000)));
    public static final RegistryObject<Item> IRON_BULLET_ITEM = ITEMS.register("iron_bullet",() -> new IronBulletItem(new Item.Properties().stacksTo(64).setNoRepair()));
    public static final RegistryObject<Item> COPPER_BULLET_ITEM = ITEMS.register("copper_bullet",() -> new CopperBulletItem(new Item.Properties().stacksTo(64).setNoRepair()));
    public static final RegistryObject<Item> ENDER_BULLET_ITEM = ITEMS.register("ender_bullet",() -> new EnderBulletItem(new Item.Properties().stacksTo(64).setNoRepair()));
    ...
    private void addCreative(CreativeModeTabEvent.BuildContents event)
    {
        if (event.getTab() == CreativeModeTabs.COMBAT) {
            event.accept(MUSKET_ITEM);
            event.accept(IRON_BULLET_ITEM);
            event.accept(COPPER_BULLET_ITEM);
            event.accept(ENDER_BULLET_ITEM);
        }
    }
    ...
    public VanillaMuskets()
    {
        ...
        // Register the Deferred Register to the mod event bus so items get registered
        VanillaMusketsSoundEvents.register(modEventBus);
